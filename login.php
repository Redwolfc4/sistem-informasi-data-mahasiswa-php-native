...
<body>
  ...
  <div>' . $_GET['error'] . '</div><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' . '</div>';
                        ...
                        <div class="text-center mb-4">
                            <h1 class="h4 mb-1">Masuk Akun</h1>
                            <p class="text-body-secondary mb-0">Masuk akun untuk akses menu utama</p>
                        </div>

                        <form class="needs-validation" novalidate action="proses_login.php" method="post">
                        ...
                        <p class="text-center mb-0 small">
                            Belum punya akun? <a href="register.php" class="link-primary text-decoration-none">Registrasi di sini</a>
                        </p>
                    </div>
                </div>

                <p class="text-center text-body-secondary small mt-3 mb-0">&copy; <span id="year"></span> Manajemen Data Mahasiswa</p>
            </div>
        </div>
    </main>
