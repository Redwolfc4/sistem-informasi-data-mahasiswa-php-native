        ...
        <div class="card">
            <form action="proses_edit.php" method="post" class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="nim" name="nim" placeholder="Masukkan nim" value="<?= $data['nim'] ?>" required>
                </div>
                <div class="mb-3">
                    <label for="jurusan" class="form-label">Jurusan</label>
                    <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Masukkan jurusan" value="<?= $data['jurusan'] ?>" required>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <button type="submit" class="btn w-50 btn-primary">Edit</button>
